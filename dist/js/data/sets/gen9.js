var SETDEX_SV = {
  ...
  "Flapple": {
    ...
    "Hex Maniac Kathleen & Psychic Nicholas": {
      "level": 86,
      "ability": "Hustle",
      "moves": [
        "Grav Apple",
  ...
  "Zamazenta-Crowned": {
    ...
    "Magma Leader Maxie & Admin Tabitha": {
      "level": 90,
      "ability": "Dauntless Shield",
      "moves": [
        "Body Press",
  ...
  "Volbeat": {
    "Triathlete Maria & Triathlete Dylan": {
      "level": 55,
      "ability": "Prankster",
      "moves": [
        "Tail Glow",
  ...
  "Greedent": {
    "Cooltrainer Lauren (Defense Room)": {
      "level": 64,
      "ability": "Gluttony",
      "moves": [
        "Body Press",
